...
from phishing_domain_detection.utils.main_utils import save_numpy_array_data, save_object
        ...
        try:
            ...
            preprocessor = Pipeline(
                steps=[
                    ...
                    ("MinMaxScaler", min_max_scaler)  # keep every feature in same range and handle outlier
                    ]
            )
