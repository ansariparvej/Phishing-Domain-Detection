...
from phishing_domain_detection.entity.artifact_entity import DataValidationArtifact, ModelTrainerArtifact, ModelEvaluationArtifact
...
from phishing_domain_detection.constant.training_pipeline import TARGET_COLUMN
import pandas as pd
